...
export async function predictChurnTemporal(input: TemporalInput) {
  ...
  const result = await session.predict('engagementSequence', entity, {
    engagementScore__mean: (currentEntity) => currentEntity.engagementScore__mean,
    engagementScore__sum: (currentEntity) => currentEntity.engagementScore__sum,
    engagementScore__min: (currentEntity) => currentEntity.engagementScore__min,
    engagementScore__max: (currentEntity) => currentEntity.engagementScore__max,
  });
