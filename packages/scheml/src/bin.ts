...
async function main() {
  await yargs(hideBin(process.argv))
    ...
    .command('inspect <trait>', 'Show detailed information about a trained trait artifact', inspectCommand)
    .command('diff <trait>', 'Compare two artifact history records for a trait', diffCommand)
